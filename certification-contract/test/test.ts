...
describe("University Certification", () => {
  ...
  describe("Deploying BUCertificatioin", () => {
    ...
    it("Deployed university certification contract", async () => {
      console.log("Deploying BUCertificatioin");
      const UBCcontract = await ethers.getContractFactory("BUCertificatioin");
      ...
      console.log(
        ...
        `npx hardhat verify --contract "contracts/BUCertificatioin.sol:BUCertificatioin" --network bscTestnet ${universityCert.address} ${deployer.address}`
        );
    });
